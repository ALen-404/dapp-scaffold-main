...
export const AppBar: React.FC = () => {
  ...
  return (
    <div>
      {/* NavBar / Header */}
      <div className="navbar flex h-20 flex-row md:mb-2 shadow-lg  text-neutral-content  border-zinc-600 bg-opacity-66">
        ...
        <div className="navbar-end">
          ...
          <div className="hidden md:inline-flex align-items-center justify-items gap-6 mr-6 cursor-pointer">
            <Link target='_blank' href="https://chromewebstore.google.com/detail/solflare-wallet/bhhhlbepdkbapadjdnnojkbgioiodbic" rel="noopener noreferrer" >
              <p>Wallet</p>
            </Link>
          </div>
        </div>
